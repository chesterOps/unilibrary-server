...
materialRouter.post("/upload", auth_middleware_1.protect, (0, auth_middleware_1.authorize)("lecturer", "admin"), material_controller_1.uploadMaterial);
materialRouter
    .route("/")
    .get(material_controller_1.getMaterials)
    .post(auth_middleware_1.protect, (0, auth_middleware_1.authorize)("lecturer", "admin"), material_controller_1.uploadMaterial);
